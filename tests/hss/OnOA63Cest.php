...
class OnOA63Cest
{
    ...
    {
        $I->wantTo('Verify Reviews > Lineup: Confirm that the advertiser lineup is the same as it was on the home page.');
    ...
    public function tryToTest(AcceptanceTester $I)
    {
        ...
        $I->amOnPage(MainPage::REVIEW_PAGE);
        $ads_exp =  $I->get_text_href_all(MainPage::ADS_BOX_REGEX);
        $phone_exp=$I->grabTextFrom(MainPage::REVIEW_S1_B1);
        $phone_exp2=$I->grabTextFrom(MainPage::REVIEW_S1_B2);
        $phone_exp3=$I->grabTextFrom(MainPage::REVIEW_S1_B3);
        $phone_exp4=$I->grabTextFrom(MainPage::REVIEW_S1_B4);
        $phone_exp5=$I->grabTextFrom(MainPage::REVIEW_S1_B5);
